...
public class InteractiveArt extends PApplet {
...
float RingOfLines = LineDiameter*.5f;
...
public void BallnLine()
{
  ...
  if (Xpos > width-Rad || Xpos < Rad) 
  {
    ...
    SpeedOfLines = SpeedOfLines + 0.015f;
    //Play the sound
    file.play();
...
public void keyPressed()
{
  ...
  else if (key == '7')
  {
    ...
    gridSize = PApplet.parseInt(NewGridSize);
  ...
  else if (key == '8')
  {
    ...
    NumberOfLines = PApplet.parseInt(NumberOfLinesFloat);
  }
...
class Ball {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "--present", "--window-color=#666666", "--stop-color=#cccccc", "InteractiveArt" };
    if (passedArgs != null) {
